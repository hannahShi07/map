...
<!--    </el-form-item>-->
    <el-form-item :label="$t('table.user.mobile')" prop="mobile">
      <el-input v-model="user.mobile" disabled="disabled"/>
    </el-form-item>
    <el-form-item :label="$t('table.user.sex')" prop="sex">
      <el-input v-model="user.sex['desc']" disabled="disabled"/>
<!--      <el-select placeholder v-model="user.sex['code']" value disabled="disabled">-->
...
<!--      </el-select>-->
    ...
    <el-form-item :label="$t('table.user.workDescribe')" prop="workDescribe">
      <el-input rows="3" type="textarea" v-model="user.workDescribe" maxlength="500"/>
    </el-form-item>
