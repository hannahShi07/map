          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="状态" prop="">
                {{isEmpty(formData.isEnable) | isEnable}}
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
...
export default {
  ...
  methods: {
    ...
    getDetail(id){
      ...
      gatewayInfo(params).then(response => {
        response.isEnable = response.isEnable.key
  ...
  filters:{
    isEnable(val){
      switch(val){
        case "2430837861936136772":
          return "启用"
          break;
        case "2430837861936146739":
          return "禁用"
          break;
        default:
          return "--";
