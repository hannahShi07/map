      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="标题" prop="title">
            <el-input v-model="formData.name" show-overflow-tooltip placeholder="园区介绍" maxlength="100" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
          <el-form-item label="简介" prop="introduction">
            <el-input type="textarea"  show-word-limit resize="none" :autosize='{ minRows: 5, maxRows: 5 }' maxlength="500" v-model="formData.brief" show-overflow-tooltip placeholder="请输入" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
