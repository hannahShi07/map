    ...
    <div class="pd-20 clearfix">
      ...
      <div class="mr-20 ml-20" v-cloak>
        ...
        >
          ...
          <el-table-column label="创建人" min-width="120px" align="center" show-overflow-tooltip>
            <template slot-scope="scope">
      ...
      <impor-add ref="refEdit" @refresh="pageChange" />
      <impor-info ref="refInfo" @refresh="pageChange" />
  </div>
</template>

<script>
import ImporAdd from './impor-add'
import ImporInfo from './impor-info'
import {gatewayList,gatewayDelete} from "@/api/backstage/sysset/administration/gateway/gateway.js"
export default {
  components: {ImporAdd,ImporInfo},
  data () {
    return {
      loading:false,
      tableData:[],
