  ...
  <div class="demeanor-add">
    <el-dialog
      ...
      <el-form ref="refForm" :model="formData" label-width="100px" :rules="node">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="封面链接" class="old-members">
              <el-input v-model="formData.linkUrl" clearable show-overflow-tooltip placeholder="请选择" maxlength="100" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
