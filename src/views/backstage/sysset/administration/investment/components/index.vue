<template>
  <div class="demeanor">
    ...
    <div class="pd-20 clearfix">
      ...
      <investment-add ref="refEdit" @refresh="pageChange" />
      <investment-info ref="refInfo" @refresh="pageChange" />
  </div>
</template>

<script>
import InvestmentAdd from './investment-add'
import InvestmentInfo from './investment-info'
import {gatewayList,gatewayDelete} from "@/api/backstage/sysset/administration/gateway/gateway.js"
export default {
  components: {InvestmentAdd,InvestmentInfo},
  data () {
    return {
      loading:false,
      tableData:[],
