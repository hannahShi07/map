<template>
  <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="isVisible" :width="width" height="1200px" top="50px">
    ...
    <div slot="footer" class="dialog-footer" style="text-align:center">
      <el-button size="medium" @click="isVisible = false">取消</el-button>
      <el-button size="medium" type="primary" :disabled="disabled" @click="submitForm">确定</el-button>
    </div>
  </el-dialog>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    initUserList () {
       authUserApi.page({ current: 1, size: 100000, model: {status: 1} })
        .then((response) => {
