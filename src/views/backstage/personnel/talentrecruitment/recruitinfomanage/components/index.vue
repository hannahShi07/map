<template>
  <div class="history">
    ...
    <!--新增-->
    <recruit-add ref="refAdd" @refresh="pageChange"/>

  </div>
</template>

<script>
  import RecruitAdd from "./recruit-add"
  import commonReq  from "@/api/public/commonReq.js"
  import {getRecruitList,getRecruitDelete} from "@/api/backstage/personnel/talentrecruitment/recruitinfomanage/recruitinfomanage.js"
  ...
  export default {
    ...
    methods: {
      ...
      pageChange (num) {
        ...
        this.loading = true;
        getRecruitList(params).then(response => {
      ...
      editBtn (t, row) {
        switch (t) {
          ...
          case 5://详情
            this.$emit('handleSwitch', {name: 'RecruitDetail', params: row})
            break
          ...
          case 6://删除
            this.$confirm('是否删除该条信息？', '提示', {
              ...
              getRecruitDelete(params).then(response => {
