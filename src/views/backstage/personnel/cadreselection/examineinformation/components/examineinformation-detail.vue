  ...
  <div class="party">
    <div>
      <div class="content-box">
        <div class="content-title"> {{isEmpty(detailCont,'djInspectMessageTitle')}}</div>
        <div class="contentDiv">
          <div class="dateRouter">
            <span  :title="detailCont.djInspectMessageOrg">发布单位： {{detailCont.djInspectMessageOrg}}</span>
          </div>
          <span class="printer">发布日期：{{detailCont.djInspectMessageDate}}</span>
        </div>
...
<script>
    ...
    import {getExamineinDetail} from "@/api/backstage/personnel/cadreselection/examineinformation/examineinformation.js"
    export default {
        name: "examineinformation-detail",
        props: {
            params: {
                type: Object,
                default: {}
