  ...
  <div class="party">
    <div>
      <div class="content-box">
        <div class="content-title"> {{isEmpty(detailCont,'djOfficerTitle')}}</div>
        <div class="contentDiv">
          <div class="dateRouter">
            <span  :title="detailCont.djOfficerOrg">发布单位： {{detailCont.djOfficerOrg}}</span>
          </div>
          <span class="printer">发布日期：{{detailCont.djOfficerDate}}</span>
        </div>
        <div class="content-main" v-if="detailCont.djOfficerContent!='' && detailCont.djOfficerContent!=undefined && detailCont.djOfficerContent!=null && detailCont.djOfficerContent!='null'" v-html="detailCont.djOfficerContent">
        </div>
...
<script>
    ...
    import {getElectedofficialsDetail} from "@/api/backstage/personnel/cadreselection/electedofficials/electedofficials.js"

    export default {
        name: "appointfile-detail",
        props: {
            params: {
                type: Object,
                default: {}
