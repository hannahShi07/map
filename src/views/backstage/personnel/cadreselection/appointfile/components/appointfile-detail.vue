  ...
  <div class="party">
    <div>
      <div class="content-box">
        <div class="content-title"> {{isEmpty(detailCont,'appointMessage')}}</div>
        <div class="contentDiv">
          <div class="dateRouter">
            <span  :title="detailCont.appointUnit">发布单位： {{detailCont.appointUnit}}</span>
          </div>
          <span class="printer">发布日期：{{detailCont.appointTime}}</span>
        </div>
        <div class="content-main" v-if="detailCont.appointContent!='' && detailCont.appointContent!=undefined && detailCont.appointContent!=null && detailCont.appointContent!='null'" v-html="detailCont.appointContent">
        </div>
...
<script>
    ...
    import {getAppointfileDetail} from "@/api/backstage/personnel/cadreselection/appointfile/appointfile.js"
