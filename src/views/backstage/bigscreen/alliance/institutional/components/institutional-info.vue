...
import {getInstitutionalDetail} from "@/api/backstage/sysset/bigscreen/alliance/institutional/institutional.js"
export default {
  name: "Info",
  data() {
    return {
