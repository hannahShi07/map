  ...
  <el-dialog
    ...
    <el-form ref="refForm" :model="formData" :rules="node" label-width="100px">
      <div class="information">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="承办主体" prop="">
              {{isEmpty(formData.undertaker)}}
            </el-form-item>
          </el-col>
        </el-row>
      </div>
...
import {getpageDetail} from "@/api/backstage/sysset/bigscreen/alliance/industryactivities/industryactivities.js"
export default {
  name: "industryactivities-deatil",
  components: {
