        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="职务" prop="">
              {{isEmpty(formData.post)}}
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item class="information-content" label="人才类型" prop="">
              <div v-html="isEmpty(formData.talentType)"></div>
            </el-form-item>
          </el-col>
        </el-row>
      </div>
...
import {getpageDetail} from "@/api/backstage/sysset/bigscreen/alliance/thinktank/thinktank.js"
export default {
  name: "thinktank-deatil",
  components: {
