...
<!--      </div>-->
    ...
    <div class="mr-20 ml-20" v-cloak>
      ...
      >
        ...
        <el-table-column label="内容展示" min-width="280px" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
            <span >{{isEmpty(tableData[scope.$index],'parkContent')}}</span>
          </template>
        </el-table-column>
    ...
    <instroduction-add ref="refEdit" @refresh="pageChange" />
    <instroduction-detail ref="refInfo" @refresh="pageChange" />
  </div>
</template>

<script>
import instroductionAdd from './instroduction-add'
import instroductionDetail from './instroduction-detail'
import {getpageList,getpageEdit} from "@/api/backstage/sysset/bigscreen/homepage/introduction/introduction.js"
export default {
  components: {instroductionAdd,instroductionDetail},
  data () {
    return {
      loading:false,
      tableData:[],
