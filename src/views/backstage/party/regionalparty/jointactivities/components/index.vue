<template>
  <div class="party">
    ...
    <!--新增-->
    <jointactivities-add ref="refAdd" @refresh="pageChange"/>

  </div>
</template>

<script>
  import JointactivitiesAdd from "./jointactivities-add"
  import db from '@/utils/localstorage'//  获取用户登录id
  import commonReq  from "@/api/public/commonReq.js"
  import {getProjectList,getProjectDetele,getAuthority} from "@/api/backstage/party/regionalparty/jointactivities/jointactivities.js"
