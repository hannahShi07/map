<template>
  <div class="party">
    ...
    <!--新增-->
    <buildpairs-add ref="refAdd" @refresh="pageChange"/>

  </div>
</template>

<script>
  import BuildpairsAdd from "./buildpairs-add"
  import db from '@/utils/localstorage'//  获取用户登录id
  import commonReq  from "@/api/public/commonReq.js"
  import {getProjectList,getProjectDetele,getAuthority} from "@/api/backstage/party/regionalparty/buildpairs/buildpairs.js"
      ...
      editBtn (t, row) {
        switch (t) {
          ...
          case 5://重置
            ...
            break
          case 8://详情
            this.$emit('handleSwitch', {name: 'BuildpairsDetail', params: row})
            break
