<template>
  <div class="party">
    ...
    <!--新增-->
    <partymassbridge-add ref="refAdd" @refresh="pageChange"/>

  </div>
</template>

<script>
  import PartymassbridgeAdd from "./partymassbridge-add"
  import db from '@/utils/localstorage'//  获取用户登录id
  import commonReq  from "@/api/public/commonReq.js"
  import {getProjectList,getProjectDetele,getAuthority} from "@/api/backstage/party/regionalparty/partymassbridge/partymassbridge.js"
      ...
      editBtn (t, row) {
        switch (t) {
          ...
          case 5://重置
            ...
            break
          case 8://详情
            this.$emit('handleSwitch', {name: 'PartymassbridgeDetail', params: row})
            break
