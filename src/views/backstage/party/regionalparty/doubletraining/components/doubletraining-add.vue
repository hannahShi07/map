...
<script>
  ...
  import {getProjectAdd,getProjectEdit,getProjectDetail} from "@/api/backstage/party/regionalparty/doubletraining/doubletraining.js"

  // import { VueEditor } from "vue2-editor";//引入富文本
  import ChooseOtherPerson from "@/components/individual/choose-other-person/index";

  export default {
    name: "doubletraining-add",
