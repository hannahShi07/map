<template>
  <div class="party">
    ...
    <!--新增-->
    <doubleproject-add ref="refAdd" @refresh="pageChange"/>

  </div>
</template>

<script>
  import DoubleprojectAdd from "./doubleproject-add"
  import db from '@/utils/localstorage'//  获取用户登录id
  import commonReq  from "@/api/public/commonReq.js"
  import {getProjectList,getProjectDetele,getAuthority} from "@/api/backstage/party/regionalparty/doubleproject/doubleproject.js"
      ...
      editBtn (t, row) {
        switch (t) {
          ...
          case 5://重置
            ...
            break
          case 8://详情
            this.$emit('handleSwitch', {name: 'DoubleprojectDetail', params: row})
            break
