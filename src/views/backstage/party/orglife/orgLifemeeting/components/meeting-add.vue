...
<script>
    ...
    import {getMeetingAdd,getMeetingEdit,getMeetingeditDetail,getMeetingType} from "@/api/backstage/party/orglife/orglifemeeting/orglifemeeting.js"
    export default {
      name: "meeting-add",
      components: {
        AddPerson
