    ...
    <base-page-tree ref="refTree" @handleTreeClick="handleTreeClick">
      ...
      <div class="page-search-box">
        <base-label-box label="活动名称">
          <el-input v-model="meetingName" @keyup.enter.native="editBtn(4)" placeholder="请输入活动名称" style="width: 280px" clearable/>
        </base-label-box>
...
<!--        </base-label-box>-->
      ...
      <div class="mr-20 ml-20" v-cloak>
        ...
        >
          ...
          <el-table-column label="活动类型" width="140"  align="center" show-overflow-tooltip>
            <template slot-scope="scope">
...
<!--            </template>-->
<!--          </el-table-column>-->
          <el-table-column label="发起人" width="140"  align="center" show-overflow-tooltip>
            <template slot-scope="scope">
              <span>{{isEmpty(tableData[scope.$index],'createUserName')}}</span>
            </template>
          </el-table-column>
          <el-table-column label="活动状态" width="140"  align="center" show-overflow-tooltip>
            <template slot-scope="scope">
...
<!--    <meeting-summary ref="refSummary" @refresh="pageChange"/>-->
    <!--详情-->
    <meeting-detail ref="refDetail" @refresh=""/>
...
<script>
  ...
  import {getMeetingList,getMeetingDetele,getMeetingExport,getMeetingType,getIsadd} from "@/api/backstage/party/orglife/otherActives/otherActives.js"
      ...
      pageChange () {
        ...
        let params = {
          ...
          model: {
            ...
            meetingType:this.selfMeetingtype.key,//会议类型
        ...
        getMeetingList(params).then(response => {
          ...
          for(let i=0;i<this.tableData.length;i++){
            ...
            if(this.tableData[i].beginTime!='' && this.tableData[i].beginTime!=undefined && this.tableData[i].beginTime!=null && this.tableData[i].beginTime!='null'){
