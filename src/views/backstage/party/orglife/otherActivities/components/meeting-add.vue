    ...
    <el-form :model="messages" :rules="node" ref="ruleForm" label-width="120px">
      <div class="base-information">
        ...
        <div class="base-content">
          <el-col :span="24">
            <el-form-item class="is-required" label="活动名称" prop="meetingName">
...
<!--          </el-col>-->
          <el-col :span="24">
            <el-form-item class="is-required" label="活动主题" prop="agenda">
...
<script>
    ...
    import {
      getMeetingAdd,
      getMeetingEdit,
      getMeetingeditDetail,
      getMeetingSummmary,
      getMeetingType
    } from "@/api/backstage/party/orglife/otherActives/otherActives.js"
    export default {
      name: "meeting-add",
      components: {
        AddPerson
