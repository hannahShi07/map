...
<script>
  ...
  import { getPartyTree,getPartyMemberList,getNameList,getNameDelete,getNameInfo,getNameAdd,getNameEdit} from "@/api/backstage/party/orglife/otherActives/otherActives.js";
  export default{
    name:'add-person',
    components:{
    },
