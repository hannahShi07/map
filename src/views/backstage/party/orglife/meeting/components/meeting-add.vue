    ...
    <el-form :model="messages" :rules="node" ref="ruleForm" label-width="120px">
      <div class="base-information">
        ...
        <div class="base-content">
          ...
          <el-col :span="6">
            <el-form-item class="is-required" label="会议类型" prop="meetingType.key">
              <el-select
                v-model="messages.meetingType.key"
                value-key="id"
                filterable
                placeholder="请选择"
                style="width:100%;"
          ...
          <el-col :span="6">
            <el-form-item label="在线会议" prop="endTime">
              <el-select
                v-model="messages.meetingWay"
                value-key="id"
                filterable
                placeholder="请选择"
                style="width:100%;"
              >
                <el-option
                  v-for="(item, index) in meetingWayList"
                  :key="index"
                  :label="item.name"
                  :value="item.id">
                </el-option>
          ...
          <el-col :span="8">
            <el-form-item class="is-required" label="记录人" prop="recorder" v-if="messages.meetingType.key!='1294085700764827648'">
              <el-input v-model="messages.recorder" placeholder="请输入" maxlength="100"  clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item class="is-required" label="授课人" prop="lecturer" v-if="messages.meetingType.key=='1294085454810841088'">
              <el-input v-model="messages.lecturer" placeholder="请输入" maxlength="100"  clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
<script>
    ...
    import {getMeetingAdd,getMeetingEdit,getMeetingeditDetail,getMeetingType} from "@/api/backstage/party/orglife/meeting/meeting.js"
    export default {
      name: "meeting-add",
      components: {
        AddPerson
        ...
        getEdit(){
          ...
          getMeetingeditDetail(params).then(response => {
            ...
            this.messages={
              ...
              meetingType:res.orgLife.meetingType,
              ...
              meetingWay:res.orgLife.meetingWay,//在线会议
