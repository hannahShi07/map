      ...
      <div class="personContainer">
        <div class="contentLeft">
          <el-form-item label="待选人员" prop="personSelect">
            ...
            <el-input class="inputSearch" placeholder="请输入人员姓名/手机号检索" clearable v-model="info" style="width:265px!important;"></el-input>
...
<script>
  ...
  import { getPartyTree,getPartyMemberList,getNameList,getNameDelete,getNameInfo,getNameAdd,getNameEdit} from "@/api/backstage/party/orglife/meeting/meeting.js";
  export default{
    name:'add-person',
    components:{
    },
    ...
    methods:{
      ...
      save(){
        ...
        console.log('this.orgs: '+JSON.stringify(this.orgs))
        console.log('this.listLi: '+JSON.stringify(this.listLi))
        console.log('this.listId: '+JSON.stringify(this.listId))
        console.log('this.participantsName: '+JSON.stringify(this.participantsName))
