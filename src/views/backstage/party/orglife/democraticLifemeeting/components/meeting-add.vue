...
<script>
    ...
    import {getMeetingAdd,getMeetingEdit,getMeetingeditDetail,getMeetingType} from "@/api/backstage/party/orglife/democraticlifemeeting/democraticlifemeeting.js"
    export default {
      name: "meeting-add",
      components: {
        AddPerson
