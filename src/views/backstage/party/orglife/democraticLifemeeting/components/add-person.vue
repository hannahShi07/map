<template>
  ...
  >
    <el-form ref="ruleForm" label-width="70px" v-cloak v-loading="loading">
...
<script>
  ...
  import { getPartyTree,getPartyMemberList,getNameList,getNameDelete,getNameInfo,getNameAdd,getNameEdit} from "@/api/backstage/party/orglife/democraticlifemeeting/democraticlifemeeting.js";
  export default{
    name:'add-person',
    components:{
    },
