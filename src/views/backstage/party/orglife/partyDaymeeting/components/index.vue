...
<script>
  ...
  import {getMeetingList,getMeetingDetele,getMeetingExport,getMeetingType,getIsadd} from "@/api/backstage/party/orglife/partydaymeeting/partydaymeeting.js"
...
<style scoped>
  ...
  .table /deep/ tr td:nth-of-type(5){
    text-align:left;
  }
