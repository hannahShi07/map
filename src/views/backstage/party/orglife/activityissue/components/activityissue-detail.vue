      ...
      <el-row class="card-row">
        <el-col :span="24">
          <div class="card-box">
            ...
            <div class="card-box-contentys" v-html="list.theme" v-if="list.theme!='' && list.theme!=undefined && list.theme!=null && list.theme!='null'">
...
<script>
  ...
  import {getMeetingDetail} from "@/api/backstage/party/orglife/activityissue/activityissue.js"
  export default {
    name: "activityissue-detail",
    data () {
      return {
        loading:true,//加载遮罩条件
        visible: false,
