    ...
    <base-page-tree ref="refTree" @handleTreeClick="handleTreeClick">
      ...
      <div class="mr-20 ml-20" v-cloak>
        ...
        >
          ...
          <el-table-column label="会议状态" width="140px" align="center" show-overflow-tooltip>
            <template slot-scope="scope">
          ...
          <el-table-column label="操作" width="360px" align="center" show-overflow-tooltip>
...
<script>
  ...
  import {getMeetingList,getMeetingDetele,getMeetingExport,getMeetingType,getIsadd} from "@/api/backstage/party/orglife/heartTalk/heartTalk.js"
