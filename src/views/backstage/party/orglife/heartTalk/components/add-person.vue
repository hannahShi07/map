...
<script>
  ...
  import { getPartyTree,getPartyMemberList,getNameList,getNameDelete,getNameInfo,getNameAdd,getNameEdit} from "@/api/backstage/party/orglife/heartTalk/heartTalk.js";
  export default{
    name:'add-person',
    components:{
    },
