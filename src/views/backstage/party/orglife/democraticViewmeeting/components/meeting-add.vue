...
<script>
    ...
    import {getMeetingAdd,getMeetingEdit,getMeetingeditDetail,getMeetingType} from "@/api/backstage/party/orglife/democraticviewmeeting/democraticviewmeeting.js"
    export default {
      name: "meeting-add",
      components: {
        AddPerson
