...
<!--        <base-label-box label="会议类型" class="title1">-->
<!--          <el-select-->
<!--            v-model="meetingType"-->
<!--            value-key="id"-->
<!--            filterable-->
...
<script>
  ...
  import {getMeetingList,getMeetingDetele,getMeetingExport,getMeetingType,getIsadd} from "@/api/backstage/party/orglife/democraticviewmeeting/democraticviewmeeting.js"
      ...
      editBtn (t, row) {
        switch (t) {
          ...
          case 5://重置
            ...
            this.orgCode='';//党组织编码
            this.orgName='';//党组织名称
            this.meetingType=this.selfMeetingtype.key;//会议类型
