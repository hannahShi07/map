      ...
      <el-row class="card-row">
        <el-col :span="24">
          <div class="card-box">
            ...
            <div class="card-box-contentys" style="flex:1" v-html="isEmpty(list,'articleDetails')">
<!--              {{isEmpty(list,'articleDetails')}}-->
            </div>
          </div>
        </el-col>
      </el-row>
...
<script>
    ...
    import {getInspectionDetail} from "@/api/backstage/party/orglife/inspection/inspection.js"
    export default {
