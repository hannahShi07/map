        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="党内职务" prop="position.key">
              <el-select v-model="formData.position.key" placeholder="请选择" :editable="false" clearable @change="getPositionId">
                <el-option
...
<script>
  import {addLeadership} from "@/api/backstage/party/class/election/election.js"
  import commonReq from "@/api/public/commonReq";
  import SelectMember from '@/views/backstage/party/class/members/components/select-member'
  export default {
    name: "ElectionSecond",
    components: {
        SelectMember
...
<style scoped>
  .election-second >>> .el-dialog{
    width: 887px;
  }
  .election-second >>> .el-input{
    width: 300px;
  }
  .information{
    padding-left:34px;
  ...
  .election-second >>> .el-textarea .el-textarea__inner{
    resize: none;
  }
  .election-second >>> .information{
    padding-bottom: 0;
  }
  .election-second >>> .el-dialog__body{
    padding-bottom: 0;
  }
  .election-second >>> .el-dialog__footer{
    padding-top: 0;
  }
  .election-second >>> .el-form-item__error{
    left: 80px;
  }
</style>
