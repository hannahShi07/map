  ...
  <div v-cloak>
    <el-dialog
      ...
      <el-form ref="refForm" :model="formData" :rules="node" label-width="100px" v-cloak v-loading="loading">
        <el-row>
          <el-col :span="24">
            <el-form-item class="is-required"  label="组织名称" prop="orgName.data">
              <el-input v-model="formData.orgName.data" placeholder="请输入"   @click.native="getTree" clearable></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <div>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="奖励名称" prop="rewardName">
              <el-input placeholder="请输入"   clearable v-model="formData.rewardName"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
<script>
    ...
    import {getCultivateAdd,getCultivateName,getCultivateEdit,getCultivateDetail} from "@/api/backstage/party/priority/cultivate/cultivate.js"
        ...
        methods: {
            ...
            associationCallback(val){
                if(val){
                    ...
                    if(this.isEdit==1){
                        getCultivateAdd(params).then(response => {
                            const res = response
                        ...
                        getCultivateEdit(params).then(response => {
                            const res = response
                            this.$message(this.successTip())
                            this.close()
                            this.$emit('refresh')
            ...
            getOrgName(){
                let params = {}
                getCultivateName(params).then(respone =>{
                    const res = respone
            ...
            editEcho(id){
                ...
                getCultivateDetail(params).then(respone =>{
                    const res = respone
