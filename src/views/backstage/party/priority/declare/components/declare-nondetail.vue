  ...
  <div class="declare-detail" v-cloak v-loading="loading">
    <div class="title-bar clearfix">
      <div class="logotxt fl">
        ...
        <span>{{isEmpty(baseList,'orgId.data')}}</span> <span style="margin-left: 10px">{{isEmpty(baseList,'declareAwards.data')}}候选对象申请表</span>
      </div>
      <div class="fr" v-if="baseList.checkState.data == '待审核'">
<!--        <el-button class="js-button" disabled="disabled">编辑</el-button>-->
      </div>
      <div class="fr" v-if="baseList.checkState.data == '通过'"></div>
      <div class="fr" v-if="baseList.checkState.data == '不通过'"></div>
    ...
    <base-card-box header="党组织所在企业基本情况"  imgSquare>
      <el-row class="card-row" v-if="baseList.declareAwards.key=='2279092149023375369'||baseList.declareAwards.key=='2279092149023375366'">
        <el-col :span="24">
          <div class="card-box">
            ...
            <div class="card-box-content">
              {{isEmpty(baseList,'enterpriseId.data')}}
            </div>
          </div>
        </el-col>
      </el-row>
      <el-row class="card-row" v-if="baseList.declareAwards.key=='2279092149023375372'">
        <el-col :span="24">
          <div class="card-box">
            <div class="card-box-title">
              企业名称
    ...
    <base-card-box header="党建工作基本情况" imgSquare>
      ...
      <el-row class="card-row">
        ...
        <el-col :span="8" v-if="baseList.declareAwards.key=='2279092149023375369'">
          <div class="card-box">
...
<script>
    ...
    import {getDeclareNonDetail,getDeclareNonExport} from "@/api/backstage/party/priority/declare/declare.js"
    export default {
        name: 'declareAdd',
        props: {
            params: {
        ...
        methods: {
            ...
            getDetail(){
                ...
                getDeclareNonDetail(params).then(respone => {
                    const res = respone
                    this.baseList = res
