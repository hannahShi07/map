    ...
    <el-form :model="declareAwardData" :rules="node" ref="refForm" label-width="120px">
      <div class="base-information">
        ...
        <div class="base-content">
          <el-col :span="24" v-if="baseList.declareAwards.key=='2279092149023375369'||baseList.declareAwards.key=='2279092149023375366'">
          <el-form-item class="is-required" label="社会组织名称" prop="companyId.data">
            <el-select
              v-model="declareAwardData.companyId.data"
              value-key="id"
              filterable
              placeholder="请选择"
              style="width: 100%"
          ...
          <el-col :span="24" v-if="baseList.declareAwards.key=='2279092149023375372'">
          ...
          <el-col :span="24" class="select-list">
            <el-form-item class="is-required" label="地址" prop="province">
              ...
              <el-input v-model="declareAwardData.companyAddress" placeholder="请输入详细地址" :disabled="inputDisabled" maxlength="200"
                        clearable></el-input>
          ...
          <el-col :span="8" v-if="baseList.declareAwards.key=='2279092149023375372'">
      ...
      <div class="base-information">
        ...
        <div class="base-content">
          ...
          <el-col :span="16" v-if="baseList.declareAwards.key=='2279092149023375369'">
            <el-form-item class="is-required  card_multiple" label=" 哪年被命名为市级“双比双争”先进社会组织党组织" prop="orgCreateTime">
              <el-date-picker
                v-model="declareAwardData.orgCreateTime"
                type="date"
                placeholder="请输入"
          ...
          <el-col :span="16" v-if="baseList.declareAwards.key=='2279092149023375372'">
            <el-form-item class="is-required  card_multiple" label=" 哪年被命名为市级 “双强六好”非公企 业党组织" prop="orgCreateTime">
              <el-date-picker
                v-model="declareAwardData.orgCreateTime"
                type="date"
                placeholder="请输入"
          ...
          <el-col :span="24">
            <el-form-item class="is-required card_multiple" label="开展“双强六好”创建活动、抓党建工作的主要事迹" prop="advancedDeed">
              <el-input v-model="declareAwardData.advancedDeed" :disabled="inputDisabled" placeholder="请输入" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
<script>
    ...
    import {getRecordNonDetail} from "@/api/backstage/party/priority/record/record.js"
        ...
        data() {
            return {
                ...
                declareAwardData: {
                    ...
                    advancedDeed: '',//开展“双强六好”创建活动、抓党建工作的主要事迹
            ...
            getDetail() {
                ...
                getRecordNonDetail(params).then(respone => {
                    ...
                    // this.declareAwardData.companyAddress = res.enterpriseAddress,//地址
                        ...
                        this.declareAwardData.isCreateParty = res.isCreateUnions,//是否建立工会
                        ...
                        this.declareAwardData.advancedDeed = res.advancedDeed,//开展“双强六好”创建活动、抓党建工作的主要事迹
                ...
                this.$refs['refForm'].validate((valid) => {
                    if (!valid) {
                        ...
                        let params = {
                            ...
                            advancedDeed: this.declareAwardData.advancedDeed,//开展“双强六好”创建活动、抓党建工作的主要事迹
