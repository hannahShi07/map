        ...
        <div class="base-content">
          ...
          <el-col :span="8">
            <el-form-item class="is-required" label="资产总额" prop="totalAssets">
              <el-input v-model.number="declareAwardData.totalAssets" type="num" placeholder="请输入"   clearable>
                <i slot="suffix">万元</i>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item  class="is-required card_multiple" label="2017年营收总额" prop="preYearRevenue">
              ...
              <el-input v-model.number="declareAwardData.preYearRevenue" type="num"  placeholder="请输入"   clearable>
                <i slot="suffix">万元</i>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item class="is-required card_multiple" label="2017年纳税总额" prop="preYearRatepay">
              ...
              <el-input v-model.number="declareAwardData.preYearRatepay" type="num" placeholder="请输入"   clearable>
                <i slot="suffix">万元</i>
              </el-input>
            </el-form-item>
          </el-col>
        ...
        <div class="base-content">
          ...
          <el-col :span="8">
            <el-form-item class="is-required" label="所属党组织" prop="orgId.data">
              <el-input v-model="declareAwardData.orgId.data" placeholder="请输入"   @click.native="getTree" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item  class="is-required" label="党员数" prop="memberNum">
              <el-input v-model.number="declareAwardData.memberNum" type="num"  placeholder="请输入"   clearable>
                <i slot="suffix">名</i>
              </el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="8">
            <el-form-item class="is-required card_multiple" label="2018年党组织工作经费" prop="workExpenditure">
              ...
              <el-input v-model.number="declareAwardData.workExpenditure" type="num" placeholder="请输入"   clearable>
                <i slot="suffix">万元</i>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item class="is-required card_multiple" label="2018年发展党员数" prop="developMemberNum">
              ...
              <el-input v-model.number="declareAwardData.developMemberNum" type="num"  placeholder="请输入"   clearable>
                <i slot="suffix">名</i>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item class="is-required card_multiple" label="2018年培养入党积极分子数" prop="partyActivelyNum">
              ...
              <el-input v-model.number="declareAwardData.partyActivelyNum" type="num"  placeholder="请输入"   clearable>
                <i slot="suffix">名</i>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item class="is-required card_multiple" label="开展“双强六好”创建活动、抓党建工作的主要事迹" prop="mainDeed">
              <el-input
                v-model="declareAwardData.mainDeed"
                type="textarea"
          ...
          <el-col :span="24">
            <el-form-item  class="is-required card_multiple" label="党组织和党员、所在企业获得表彰情况" prop="recognition" >
              <el-input
                v-model="declareAwardData.recognition"
                type="textarea"
                :autosize='{ minRows: 5, maxRows:5}'
                resize="none"
                maxlength="500"
...
<script>
    ...
    import {getSixRecordAdd,getsocialOrgName,getOrgSetDisc,getSixRecordDetail} from "@/api/backstage/party/priority/awards/awards.js"
    ...
    export default {
        ...
        methods: {
            ...
            getDetail(){
                ...
                getSixRecordDetail(params).then(respone => {
                    const res = respone
            ...
            saveData(){
                ...
                getSixRecordAdd(params).then(respone => {
                    ...
                    this.$emit('handleSwitch', {name: 'ProDouDetail',params:res})
                }).finally(() => {
                })
            },
            //提交并下载
