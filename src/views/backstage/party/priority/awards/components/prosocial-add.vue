...
<!--              <el-input v-model.number="declareAwardData.contact" maxlength="13" placeholder="请输入"   clearable></el-input>-->
<!--            </el-form-item>-->
        ...
        methods: {
            ...
            saveData(){
                ...
                getNonRecordAdd(params).then(response => {
                    ...
                    // this.close()
                    this.$emit('refresh')
                    this.$emit('handleSwitch', {name: 'prosocialDetail',params:res})  //详情
                }).finally(() => {
                })
            },
            //提交并下载
