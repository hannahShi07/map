    ...
    <el-form :model="declareAwardData" :rules="node" ref="refForm" label-width="120px">
      <div class="base-information">
        ...
        <div class="base-content">
          <el-col :span="24">
            <el-form-item class="is-required" label="社会组织名称" prop="companyId.key">
              <el-select
      ...
      <div class="base-information">
        ...
        <div class="base-content">
          ...
          <el-col :span="8">
            <el-form-item class="is-required card_multiple" label="哪年被命名为市级“双比双争”先进社会组织党组织" prop="awardedYear">
              <el-date-picker
...
<script>
    ...
    export default {
        ...
        data () {
            return {
                ...
                declareAwardData:{
                    ...
                    awardedYear:'',//哪年被命名为市级“双比双争”先进社会组织党组织
                ...
                node: { // 必填项判断
                    ...
                    'awardedYear':{
                        required: true,
                        message: "请输入哪年被命名为市级“双比双争”先进社会组织党组织",
                        trigger: "blur"
                    },
                    'workExpenditure':{
                        required: true,
        ...
        methods: {
            ...
            getDetail(){
                ...
                getNonRecordDetail(params).then(respone => {
                    ...
                    this.declareAwardData.companyId.key = res.enterpriseId.key,
                        ...
                        this.declareAwardData.awardedYear = res.awardedYear, //哪年被命名为市级“双比双争”先进社会组织党组织
            ...
            companyChange(value){
                for(var i=0;i<this.orgNameList.length;i++){
                    if(value==this.orgNameList[i].id){
                        this.declareAwardData.legalPerson = this.orgNameList[i].legalPerson;
                        this.declareAwardData.secretary = this.orgNameList[i].secretary.data;
                        this.declareAwardData.memberNum = this.orgNameList[i].memberNum;
                        this.declareAwardData.orgSet.data = this.orgNameList[i].category.data;
                        this.declareAwardData.orgSet.key = this.orgNameList[i].category.key;
                        this.declareAwardData.approvalDate = this.orgNameList[i].approvalDate;
                        this.declareAwardData.orgId.data = this.orgNameList[i].orgId.data;
                        this.declareAwardData.orgId.key = this.orgNameList[i].orgId.key;
                        this.declareAwardData.isCreateTeam = this.orgNameList[i].isYouthLeague.data;
                        this.declareAwardData.isCreateParty = this.orgNameList[i].isUnion.data;
                        this.declareAwardData.workExpenditure = this.orgNameList[i].workingFunds;
                        this.declareAwardData.developMemberNum = this.orgNameList[i].devMemberNum;
                        this.declareAwardData.partyActivelyNum = this.orgNameList[i].activeMemberNum;
                    }
                }
            },
            //家庭地址-省
            ...
            saveData(){
                ...
                let params = {
                    ...
                    awardedYear:this.declareAwardData.awardedYear,//哪年被命名为市级“双比双争”先进社会组织党组织
                ...
                getNonRecordAdd(params).then(response => {
                    ...
                    this.$emit('refresh')
                    this.$emit('handleSwitch', {name: 'socialOrgDetail',params:res})  //详情
                })
            },
            //提交并下载
            save(){
