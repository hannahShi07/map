...
<script>
    ...
    import {getRecordExport} from "@/api/backstage/party/priority/record/record.js"
    import {getSixRecordDetail} from "@/api/backstage/party/priority/awards/awards.js"
    ...
    export default {
        ...
        methods: {
            ...
            //编辑
            toEdit(row){
                this.$emit('handleSwitch', {name: 'ProDouAdd', params: row})
                // this.visible = true
            },
            //导出
            toExport(){
