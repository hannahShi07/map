<template>
  <el-dialog
    ...
    <div class="heigh-cla">
      <base-label-box>
        <el-input class="inputSearch" placeholder="请输入组织名称" clearable v-model="name" @keyup.enter.native="selectName()"></el-input>
      ...
      <base-label-box class="over">
        ...
        >
          ...
          <el-table-column label="组织名称" min-width="120px" align="center" show-overflow-tooltip>
            <template slot-scope="scope">
...
<script>
  import { getOrgList } from "@/api/backstage/party/dues/return/return.js"
  export default {
    name: "select-member",
    data(){
      return{
