    ...
    <div>
      <div class="content-box">
        ...
        <div class="contentDiv">
          <div class="dateRouter"><span>发布单位：{{isEmpty(detailCont,'orgId.data')}}</span></div>
          <div class="dateRouter"><span>发布日期：{{isEmpty(detailCont,'wageDate')}}</span></div>
        </div>
        ...
        <div class="content-attachment">
          ...
          <div class="content-box-content content-box-content1">
            <div v-if="fileList!='' && fileList!=undefined && fileList!=null && fileList!='null' && fileList.length>0" class="content-file" v-for="(item,index) in fileList"  @click="download(item.url)">
...
<script>
    ...
    import {getDynamicworkDetail} from "@/api/front/party/informationPush/dynamicwork/dynamicwork.js"
    export default {
        name: "work-detail",
        props: {
            params: {
