...
<script>
  ...
  import {getMeetingList,getMeetingTable} from "@/api/front/party/orglife/democraticreview/democraticreview.js"
  ...
  export default {
    ...
    data () {
      return {
        ...
        lifeType:'1294085858311274496',//会议类型
        dicts: {//字典
          life_type:{},//会议类型
          // life_state:{},//会议状态
        },
    ...
    methods: {
      ...
      getDict(){
        ...
        commonReq.getHistoryDict(params).then(response =>{
          const res = response;
          this.dicts.life_type= res.life_type;
        })
      },
      //获取用户信息
      getUser(){
