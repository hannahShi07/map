  ...
  <div class="history-detail">
    <!-- <el-tabs v-model="activeName" v-loading="loading">
      <el-tab-pane label="基本信息" name="1" v-cloak> -->
        ...
        <base-card-box header="基本信息" isImg :imgUrl="imgUrl">
          <el-row class="card-row">
            ...
            <el-col :span="8" style="padding-right: 150px">
              <div class="card-box">
                <div class="card-box-title">
                  组织类别
                </div>
        ...
        <base-card-box header="组织奖惩信息" :margin="{top: true}" :headerBottomBorder="false" v-cloak>
          <div style="margin: 0 20px;">
            <el-table :data="baseList.orgPrizePunishList" header-row-class-name="page-table-header">
              ...
              <el-table-column label="奖惩名称" width="300" prop="nameId" align="center" show-overflow-tooltip>
                <template slot-scope="scope">
                  {{isEmpty(baseList.orgPrizePunishList[scope.$index],'name')}}
                </template>
              </el-table-column>
              <el-table-column label="奖惩类型" min-width="160" prop="instructions" align="center" show-overflow-tooltip>
                <template slot-scope="scope">
  ...
  export default {
    ...
    data () {
      return {
        loading:true,//加载遮罩条件
        activeName: '1',//tab切换
        imgUrl: require('@/assets/temp/temp-head.png'),//图片
        baseList:[],//基本信息
        detailFile: [],//发展流程相关附件
      }
    },
    ...
    methods: {
      ...
      geBaseDetail(){
        ...
        //党组织框架详情
          ...
          const res = respone
          this.baseList = res
          console.log(this.baseList.unifyCode.length)
        }).finally(() =>{
            this.loading = false;
        })
      },
...
<style lang="scss" scoped>
  /deep/.base-card-box .base-card-box__body .head-img img{
    width: 112px;
    height: 112px;
  }
  .history-detail {
