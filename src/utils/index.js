 ...
 * */
export function getNowDateObjQString (type = 'object') {
  ...
  if (type === '') {
    ...
    return `${year}年${d.getMonth() + 1}月${d.getDate()}日 ${week[d.getDay()]} ${(hour > 9 ? hour : '0' + hour) + ':' + (minute > 9 ? minute : '0' + minute) + ':' + (second > 9 ? second : '0' + second)}`
  }
}
