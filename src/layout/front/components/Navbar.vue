<template>
  <div class="navbar">
    <div class="left-main">
      ...
      <i class="iconfont icon-danghui font-size" style="color:#FFDE00"/>
      <span>智慧党建云平台</span>
    </div>
    ...
    <div class="left-menu">
      <div class="left-item">
        <router-link
          ...
          v-for="(item, index) in frontHeader" >
          <i :class="isClass(item)" class="color-white"/>
          <span>{{item.name}}</span>
        </router-link>
      </div>
    </div>
    ...
    <div class="right-menu color-white">
      ...
      <div class="inlineBlock menu-back ">
        <!--先锋网 start-->
        <!--<router-link class="spacing-left spacing-right" to="/backstage/party/basic/party/index">
          <i class="iconfont icon-pioneer font-size"/>
        </router-link>-->
        <a class="spacing-left spacing-right" onclick="window.open('http://www.sszzb.gov.cn/', '_blank')">
        <el-popover
        ...
        <!--切换到后台 start-->
        <router-link class="spacing-back spacing-right"   :to="defLaterPath" v-if="defLaterPath !== ''">
          <el-popover
        ...
        <!--消息通知 start  -->
<!--        <router-link to="/backstage/party/basic/party/index">-->
          <!--<el-popover-->
            <!--popper-class="poppver-class"-->
            <!--placement="bottom-end"-->
            <!--trigger="hover"-->
...
<!--        </router-link>-->
      ...
      >
        ...
        <el-dropdown-menu slot="dropdown">
          <router-link to="/profile-front/index">
            ...
            <!--<ul class="newsul" v-if="noticetableData!='' && noticetableData!=undefined && noticetableData!=null && noticetableData!='null' && noticetableData.length>0">-->
              <!--<li v-for="(items,index) in noticetableData" @click="opennoticeDetail(items)">-->
                <!--<div class="newtitle">-->
                  <!--<h2>{{items.title}}</h2>-->
                <!--</div>-->
                <!--<div class="newtxt" v-html="items.content">-->
<!--&lt;!&ndash;                  {{items.content}}&ndash;&gt;-->
                <!--</div>-->
                <!--<div class="newdetail">-->
        ...
        <!--</el-tab-pane>-->
      <!--</el-tabs>-->
      <!--<div class="newsfooter" v-if="activeName=='first' && noticetableData!='' && noticetableData!=undefined && noticetableData!=null && noticetableData!='null' && noticetableData.length>0">-->
        ...
        <!--</router-link>-->
      <!--</div>-->
      <!--<div class="newsfooter" v-if="activeName=='second' && newstableData!='' && newstableData!=undefined && newstableData!=null && newstableData!='null' && newstableData.length>0">-->
...
<!--&lt;!&ndash;              {{isEmpty(noticeData,'content')}}&ndash;&gt;-->
            <!--</div>-->
  ...
  export default {
    ...
    data () {
      return {
        ...
        defLaterPath: db.get('DEF_LATER_PATH', ''),
      }
    },
    computed: {
      frontHeader () {
        return this.$store.state.account.routes.frontHeader
      },
      avatar () {
        const user = this.$store.state.account.user;
        console.log(this.$store.state.account.user,111)
        if (!user["avatar"]) {
    ...
    methods: {
      ...
      isClass(item){
          ...
          }else if(valName == '党务工作'){
            return 'iconfont icon-party-affairs-copy'
          }else if(valName == '党员教育'){
            return 'iconfont icon-education-copy'
          }else if(valName == '人事人才'){
            return 'iconfont icon-personnel'
          }else if(valName == '学习园地'){
            return 'iconfont icon-study'
          }else if(valName == '企业服务'){
            return 'iconfont icon-real-time'
          }else if(valName == '综合研判'){
            return 'iconfont icon-judge'
          }*/
          if(item && item.meta){
...
<style lang="scss" scoped>
 ...
 /deep/ .v-modal{
  ...
  /*.newsul li .newdetail .newtime /deep/ .el-icon-time:before{*/
  /*  padding-right:5px;*/
  /*}*/
